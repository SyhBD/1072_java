...
public class BankAccount {
	...
	public void deposit(double amount) throws SQLException {
		...
		try {
			PreparedStatement stat = conn
					.prepareStatement("UPDATE Bank_Account" + " SET Balance = Balance + ?" + " WHERE Account_Number = ?");
	...
	public double getBalance() throws SQLException {
		...
		try {
			double balance = 0;
			PreparedStatement stat = conn.prepareStatement("SELECT Balance FROM Bank_Account WHERE Account_Number = ?");
